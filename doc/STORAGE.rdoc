...
The default backend is <tt>utxo::sqlite:~/.bitcoin-ruby/<network>/blocks.db</tt>, which is a sqlite database called +blocks.db+ in a directory named after the network you're using, inside your homedir.
