...
describe 'BIP143 spec' do
  ...
  it 'Native P2WPKH' do
    ...
    tx.witness.add_witness(TxInWitness.new)
    ...
    wit1 = TxInWitness.new
    wit1.add_stack(sig1.bth)
    wit1.add_stack('025476c2e83188368da1ff3e292e7acafcdb3566bb0ad253f62fc70f07aeee6357')
    tx.witness.add_witness(wit1)
  ...
  it 'P2SH-P2WPKH' do
    ...
    wit = TxInWitness.new
    wit.add_stack(sig.bth)
    wit.add_stack('03ad1d8e89212f0b92c74d23bb710c00662ad1470198ac48c43f7d6f93a2a26873')
    tx.witness.add_witness(wit)
  ...
  it 'Native P2WSH' do
    ...
    wit1 = TxInWitness.new
    wit1.add_stack(sig2.bth)
    wit1.add_stack(sig1.bth)
    wit1.add_stack(witness_script.to_payload.bth)
    tx.witness.add_witness(wit1)
  ...
  it 'P2SH-P2WSH' do
    ...
    wit.add_stack('') # for multisg op_0
    ...
    wit.add_stack(sig5.bth)

    wit.add_stack(witness_script.to_payload.bth)
